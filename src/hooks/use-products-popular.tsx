...
export function useProductsPopular(limit: number) {
    ...
    const fetchPopularProducts = async () => {
        try {
            ...
            const response = await fetch(`http://127.0.0.1:8000/products/suggestions?popular=true&limit=${limit}&offset=0`)
    ...
    return { popularProducts, loading, error, fetchPopularProducts }
}